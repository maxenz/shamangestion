...
class LocalidadesControllerTest < ActionController::TestCase
  ...
  test "should create localidad" do
    assert_difference('Localidad.count') do
      post :create, localidad: { AbreviaturaId: @localidad.AbreviaturaId, Descripcion: @localidad.Descripcion, PartidoId: @localidad.PartidoId, ProvinciaId: @localidad.ProvinciaId, flgDefault: @localidad.flgDefault }
    end
  ...
  test "should update localidad" do
    put :update, id: @localidad, localidad: { AbreviaturaId: @localidad.AbreviaturaId, Descripcion: @localidad.Descripcion, PartidoId: @localidad.PartidoId, ProvinciaId: @localidad.ProvinciaId, flgDefault: @localidad.flgDefault }
    assert_redirected_to localidad_path(assigns(:localidad))
  end
